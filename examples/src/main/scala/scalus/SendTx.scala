...
object SendTx:
  ...
  def main(args: Array[String]): Unit =
    val cborHex = OptimizedPreimageValidator.doubleCborHex
    ...
    val redeemer = ByteString(preimageBytes).toData
    println(s"Script SIR")
    println(OptimizedPreimageValidator.compiledOptimizedPreimageValidator.pretty.render(100))
    println(s"Script double CBOR: ${OptimizedPreimageValidator.doubleCborHex}")
